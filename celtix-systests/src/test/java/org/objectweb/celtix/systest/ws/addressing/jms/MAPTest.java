...
public class MAPTest extends ClientServerTestBase implements VerificationCache {
    ...
    private static final QName SERVICE_NAME = 
        new QName("http://celtix.objectweb.org/hello_world_jms", "JMSSOAPServiceAddressing");
    private static final QName PORT_NAME =
        new QName("http://celtix.objectweb.org/hello_world_jms", "HWJMSAddressingPort");
    private static Map<Object, Map<String, String>> messageIDs =
        new HashMap<Object, Map<String, String>>();
    private HelloWorldPortType greeter;
