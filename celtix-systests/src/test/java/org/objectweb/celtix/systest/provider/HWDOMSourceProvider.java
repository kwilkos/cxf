...
@WebServiceProvider(portName = "SoapPortRPCLit1", serviceName = "SOAPServiceRPCLit",
                      targetNamespace = "http://objectweb.org/hello_world_rpclit",
 wsdlLocation = "/wsdl/hello_world_rpc_lit.wsdl")
@ServiceMode(value = Service.Mode.MESSAGE)
public class HWDOMSourceProvider implements Provider<DOMSource> {
