...
public class SOAPService extends Service {
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Project/jaxws-2.0ea2/bin/hello_world_doc_lit.wsdl");
    ...
    private static final QName SOAPPORT = new QName("http://objectweb.org/hello_world_doc_lit", "SoapPort");
