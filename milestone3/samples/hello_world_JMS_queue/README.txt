...
From the samples/hello_world_JMS_queue directory, the ant build script
...
From the samples/hello_world_JMS_queue directory, first create the target
...
From the samples/hello_world_JMS_queue directory run the commands, entered on a
single command line:
