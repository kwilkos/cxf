...
public class JAXWSClassServiceBuilderTest extends TestCase {
    ...
    public void testBasicClass() throws Exception {
        ServiceInfo service = JAXWSClassServiceBuilder
        ...
        assertEquals("did not generate the correct number of methods", 
                     6, binding.getOperations().size());
        
        OperationInfo op = binding.getOperation("sayHi");
        ...
        op = binding.getOperation("greetMeOneWay");
        ...
        op = binding.getOperation("testDocLitFault");
